...
//nit
CPlayerTask* CTaskFactoryV2::GoalieV1(const TaskT& task) {
    return MakeTask< CGoalieV1 >(task);
}

CPlayerTask* CTaskFactoryV2::GoRush(const TaskT& task) {
    return MakeTask< CGoRush >(task);
}
