...
//        }
    ...
    CGeoPoint GetPoint(const CGeoPoint& targetPoint1,const double dir1, const CGeoPoint& targetPoint2,const double dir2){
        CGeoLine dirLine1(targetPoint1, dir1);
        CGeoLine dirLine2(targetPoint2, dir2);
        CGeoLineLineIntersection GetPoint(dirLine1, dirLine2);
